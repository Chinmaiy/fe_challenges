        ...
        return this.props.streams.map(stream => {
            return (
                <div 
                    ...
                    key={stream.id}
                >
                     {this.renderAdminButtons(stream) /*called here so semanticui to display correctly*/}  
...
const mapStateToProps = state => {
    return {
        streams: Object.values(state.streams), //turn the state.stream object into an array of its values
